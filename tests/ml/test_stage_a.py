...
from ml4_stage_a_selection import (CFG4, INCUMBENT, LOW_SUPPORT_YEAR,  # noqa: E402
...
class TestHoldoutFirewall(unittest.TestCase):
    ...
    def test_no_ml4_source_file_loads_the_2026_targets(self):
        for name in ("ml4_stage_a_selection.py",):
            src = (ROOT / "scripts" / "experiments" / name).read_text()
