...
**Reproduce:** `./.venv/bin/python scripts/run_ml4_stage_a.py` then `./.venv/bin/python scripts/validate_ml4_results.py`
...
> [`scripts/validate_ml4_results.py`](../scripts/validate_ml4_results.py) check 1
...
Recorded in [`config/ml4_stage_a.json`](../config/ml4_stage_a.json) as
