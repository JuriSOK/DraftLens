...
Configuration is version-controlled in [`config/ml3_baselines.json`](../config/ml3_baselines.json). Companion documents: [ML_SPEC.md](ML_SPEC.md), [ML2_REPORT.md](ML2_REPORT.md), [ML1_REPORT.md](ML1_REPORT.md).
