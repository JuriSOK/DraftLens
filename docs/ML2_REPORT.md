...
```bash
./.venv/bin/python scripts/build_ml2_features.py --reference
./.venv/bin/python scripts/validate_ml2_features.py
./.venv/bin/python -m unittest discover -s tests
```

Companion documents: [ML_SPEC.md](ML_SPEC.md), [ML1_REPORT.md](ML1_REPORT.md), [ML0_REPORT.md](ML0_REPORT.md), [DECISIONS.md](DECISIONS.md). Formulas are contractually documented in [`config/ml2_feature_dictionary.csv`](../config/ml2_feature_dictionary.csv) — that file, not this report, is the source of truth.
