...
**Reproduce:** `./.venv/bin/python scripts/experiments/ml1_eda.py` → `data/interim/ml1/`

Companion documents: [ML_SPEC.md](../ML_SPEC.md), [ML0_DATASET.md](ML0_DATASET.md), [DATA.md](../DATA.md), [DECISIONS.md](../DECISIONS.md).
...
**Implemented:** `position_3` (G/F/C) from `hoopr_position`, in [`src/draftlens/features/positions.py`](../../src/draftlens/features/positions.py) with the table in [`config/features/position_map.csv`](../../config/features/position_map.csv), unit-tested.
