...
**Reproduce:** `./.venv/bin/python scripts/run_ml5_stage_b.py` then `./.venv/bin/python scripts/validate_ml5_results.py`
...
> inspected. Enforced by [`scripts/validate_ml5_results.py`](../scripts/validate_ml5_results.py)
...
2025 fold had two undrafted prospects and distorted the entire ML-4 leaderboard (ML4_REPORT
...
[`config/ml5_stage_b.json`](../config/ml5_stage_b.json).
...
interpretable. This is the same caveat as ML4_REPORT §15 and constrains how explanations
