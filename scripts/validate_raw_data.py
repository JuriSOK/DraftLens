"""Validate acquired DraftLens raw data and emit a data-quality profile.
...
stability. Computes no model features.
  ...
  ./.venv/bin/python scripts/validate_raw_data.py --skip-checksums
"""
...
from dlcommon import (RAW, ROOT, load_manifest, normalize_name,  # noqa: E402
                      sha256_file)
