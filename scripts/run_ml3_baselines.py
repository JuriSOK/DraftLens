"""ML-3 — temporal baselines and preprocessing experiments (Stage A).
...
2026 is never loaded, never predicted, never evaluated.
  ...
  ./.venv/bin/python scripts/run_ml3_baselines.py
...
from ml3_common import (COMPOSITE_COLS, OUT, assert_no_holdout,  # noqa: E402
                        b0_prevalence, b1_scoring_only,
                        b2_standardised_composite,
                        b4_position_percentile_composite, board_metrics,
                        calibration_bins, folds, load_config,
                        load_development, load_robustness, make_pipeline,
                        position_median_impute, resolve_features,
                        stage_a_metrics)
...
def robustness_check(dev, best_lr_name, cfgs):
    ...
    """
    from ml3_common import stage_a_metrics as _m
